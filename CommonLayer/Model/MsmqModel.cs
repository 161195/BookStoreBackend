     ...
     public class MsmqModel
    {
        ...
        private void MsmqReceiver(object sender, ReceiveCompletedEventArgs e)
        {
            try
            {
                ...
                MailMessage message = new MailMessage("mayuritesting0123@gmail.com", receiverMail);
                message.Body = Body;
                ...
                NetworkCredential credential = new NetworkCredential("mayuritesting0123@gmail.com", "testing@95");
